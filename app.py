...
TRANSLATIONS = {
    'en': {
        ...
        # ── Questions
        'q1':'How does your skin feel ~1 hour after washing with no products?',
        ...
        'q6':'How does your skin react to new skincare products?',
        'q6a1':'Often gets irritated or red','q6a2':'Sometimes breaks out',
        'q6a3':'Rarely reacts','q6a4':'Absorbs quickly, always needs more',
        'q7':'What best describes your overall skin texture?',
        'q7a1':'Rough, flaky or tight','q7a2':'Smooth in some areas, oily in others',
        'q7a3':'Smooth and balanced overall','q7a4':'Consistently shiny and greasy',
        'q8':'Press a clean tissue on your face — what happens?',
        'q8a1':'Lots of oil all over','q8a2':'Oil mainly from T-zone',
        'q8a3':'Very little oil','q8a4':'Almost nothing, skin is dry',
        # ── SUS
        'sus_title':'System Usability Scale (SUS)',
        'sus_sub':'Help improve DermaScan — answer 10 quick questions about your experience',
        'sus_instruction':'For each statement, select how much you agree or disagree on a scale of 1 to 5.',
        'sus_scale_1':'1 = Strongly Disagree','sus_scale_2':'2 = Disagree',
        'sus_scale_3':'3 = Neutral','sus_scale_4':'4 = Agree','sus_scale_5':'5 = Strongly Agree',
        ...
        'sus_q4':'I think that I would need the support of a technical person to use this system.',
        ...
        'sus_submit':'Calculate My SUS Score →',
        'sus_note':'Important: Some questions are positive, some are negative. Please read each carefully.',
        'sus_your_score':'Your SUS Score',
        'sus_out_of':'out of 100',
        'sus_thanks':'Thank you for your feedback! Saved for research.',
        'sus_another':'Submit Another Response',
        # ── History & Compare
        'history_title':'My Skin History',
        ...
        'compare_title':'Compare Results',
        'compare_sub':'Side-by-side comparison of both analysis methods.',
    ...
    'th': {
        ...
        'progress_label':'ตอบแล้ว',
        'submit_note_ready':'พร้อมแล้ว! คลิกเพื่อดูผลลัพธ์',
        'submit_note_remaining':'ยังเหลืออีก {} ข้อ',
        # ── Questions
        'q1':'ผิวของคุณรู้สึกอย่างไรหลังล้างหน้าประมาณ 1 ชั่วโมง (ไม่ทาครีมใดๆ)?',
        'q1a1':'ตึงมากและไม่สบาย','q1a2':'ตึงเล็กน้อย',
        'q1a3':'สบาย สมดุลดี','q1a4':'ปกติ ไม่รู้สึกอะไรเป็นพิเศษ',
        'q2':'ตอนกลางวัน ผิวของคุณเป็นอย่างไร?',
        'q2a1':'มันวาวทั้งใบหน้า','q2a2':'มันเฉพาะบริเวณ T-zone (หน้าผาก จมูก คาง)',
        'q2a3':'เหมือนตอนเช้า','q2a4':'แห้งและตึงมากขึ้น',
        'q3':'คุณเป็นสิวบ่อยแค่ไหน?',
        'q3a1':'บ่อยมาก ทั่วหน้า','q3a2':'เป็นบางครั้ง โดยเฉพาะ T-zone',
        'q3a3':'แทบไม่เป็น','q3a4':'แทบไม่เป็น แต่ผิวลอก',
        'q4':'ผิวรู้สึกอย่างไรเมื่อไม่ทามอยส์เจอร์ไรเซอร์ประมาณ 2-3 ชั่วโมง?',
        'q4a1':'แห้งมาก ลอก หรือคัน','q4a2':'แห้งเล็กน้อยบางบริเวณ',
        'q4a3':'ปกติ ไม่มีปัญหา','q4a4':'มันขึ้นมาเร็ว',
        'q5':'รูขุมขนของคุณเป็นอย่างไรเมื่อมองในกระจก?',
        'q5a1':'ใหญ่และเห็นชัด โดยเฉพาะบริเวณจมูก','q5a2':'เห็นชัดเฉพาะ T-zone',
        'q5a3':'เล็กและแทบมองไม่เห็น','q5a4':'เล็กมาก ผิวดูตึง',
        'q6':'ผิวของคุณตอบสนองต่อผลิตภัณฑ์สกินแคร์ใหม่อย่างไร?',
        'q6a1':'มักแดงหรือระคายเคือง','q6a2':'เป็นสิวบางครั้ง',
        'q6a3':'แทบไม่มีปฏิกิริยา','q6a4':'ซึมเร็ว รู้สึกว่าต้องการมากขึ้น',
        'q7':'พื้นผิวผิวของคุณโดยรวมเป็นอย่างไร?',
        'q7a1':'หยาบ ลอก หรือตึง','q7a2':'เรียบบางส่วน มันบางส่วน',
        'q7a3':'เรียบและสมดุลโดยรวม','q7a4':'มันวาวสม่ำเสมอ',
        'q8':'เมื่อกดกระดาษทิชชูบนใบหน้า ผลเป็นอย่างไร?',
        'q8a1':'มีน้ำมันติดมามาก','q8a2':'มีน้ำมันติดมาจาก T-zone',
        'q8a3':'มีน้ำมันติดมาน้อยมาก','q8a4':'แทบไม่มีเลย ผิวแห้ง',
        # ── Results
        'result_method_quiz':'วิธีแบบสอบถาม',
        'result_method_image':'วิธีวิเคราะห์ภาพ',
        'confidence':'ความมั่นใจ',
        'characteristics':'ลักษณะผิว',
        'morning_routine_quick':'ขั้นตอนดูแลผิวตอนเช้า (สรุป)',
        'avoid':'หลีกเลี่ยง',
        ...
        'btn_export':'ดาวน์โหลดรายงาน PDF',
        # ── Skin type names
        'skin_dry':'ผิวแห้ง','skin_normal':'ผิวปกติ',
        'skin_oily':'ผิวมัน','skin_combo':'ผิวผสม',
        # ── Image tab
        'upload_title':'วางรูปภาพของคุณที่นี่',
        'upload_sub':'หรือคลิกเพื่อเลือกไฟล์',
        ...
        'verify_yes':'ใช่ ถูกต้อง!',
        'verify_no':'ไม่ ประเภทผิวจริงของฉันคือ:',
        ...
        # ── Compare
        'compare_title':'เปรียบเทียบผลลัพธ์',
        'compare_sub':'เปรียบเทียบผลจากทั้งสองวิธี',
        'combined_result':'ผลลัพธ์รวม',
        'methods_agree':'ทั้งสองวิธีสอดคล้องกัน',
        'methods_differ':'วิธีทั้งสองให้ผลต่างกัน — แบบสอบถามเป็นหลัก',
        'final_recommendation':'คำแนะนำสุดท้าย',
        # ── History
        'history_title':'ประวัติผิวของคุณ',
        'history_sub':'ติดตามการเปลี่ยนแปลงประเภทผิวของคุณ',
        'no_history':'ยังไม่มีผลลัพธ์ที่บันทึก กรุณาวิเคราะห์เพื่อเริ่มติดตาม',
        # ── SUS
        'sus_title':'ประเมินความสามารถในการใช้งาน (SUS)',
        'sus_sub':'ช่วยพัฒนา DermaScan — ตอบคำถาม 10 ข้อเกี่ยวกับประสบการณ์ของคุณ',
        'sus_instruction':'สำหรับแต่ละข้อความ เลือกระดับที่คุณ เห็นด้วย หรือ ไม่เห็นด้วย (1-5)',
        'sus_scale_1':'1 = ไม่เห็นด้วยอย่างยิ่ง',
        'sus_scale_2':'2 = ไม่เห็นด้วย',
        'sus_scale_3':'3 = เป็นกลาง',
        'sus_scale_4':'4 = เห็นด้วย',
        'sus_scale_5':'5 = เห็นด้วยอย่างยิ่ง',
        'sus_q1':'ฉันคิดว่าจะใช้ระบบนี้บ่อยๆ',
        'sus_q2':'ฉันพบว่าระบบนี้ซับซ้อนโดยไม่จำเป็น',
        'sus_q3':'ฉันคิดว่าระบบนี้ใช้งานง่าย',
        'sus_q4':'ฉันคิดว่าต้องการความช่วยเหลือจากผู้เชี่ยวชาญในการใช้ระบบนี้',
        'sus_q5':'ฉันพบว่าฟังก์ชันต่างๆ ในระบบนี้ทำงานสอดคล้องกันดี',
        'sus_q6':'ฉันคิดว่าระบบนี้มีความไม่สอดคล้องกันมากเกินไป',
        'sus_q7':'ฉันคิดว่าคนส่วนใหญ่จะเรียนรู้การใช้ระบบนี้ได้อย่างรวดเร็ว',
        'sus_q8':'ฉันพบว่าระบบนี้ใช้งานยุ่งยากมาก',
        'sus_q9':'ฉันรู้สึกมั่นใจมากในการใช้ระบบนี้',
        'sus_q10':'ฉันต้องเรียนรู้สิ่งต่างๆ มากมายก่อนที่จะใช้ระบบนี้ได้',
        'sus_submit':'คำนวณคะแนน SUS ของฉัน',
        'sus_note':'สำคัญ: บางคำถามเป็นเชิงบวก บางคำถามเชิงลบ กรุณาอ่านแต่ละข้ออย่างรอบคอบ',
        'sus_your_score':'คะแนน SUS ของคุณ',
        'sus_out_of':'จาก 100',
        'sus_thanks':'ขอบคุณสำหรับความคิดเห็น! บันทึกสำหรับงานวิจัยแล้ว',
        'sus_another':'ส่งคำตอบอีกครั้ง',
    }
}
